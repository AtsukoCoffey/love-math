...
document.addEventListener("DOMContentLoaded", function () {
    ...
    //Answer box -> set Event litener event.key "Enter"
...
function runGame(gameType) {
    ...
    //Answer box -> empty value, focus
    document.getElementById("answer-box").value = ""; //innerText, textContent, innerHTML NOT work this
